...
class gexf_file:
    ...
    def __init__(self, directed=False):
        ...
        self.creator.text = "repository_information_retriever"
        self.description = ET.SubElement(self.meta, "description")
        self.description.text = "This file represents graphs with information about ecosystem extracted from " \
                                "repositories by RIR"
        self.graph = ET.SubElement(self.gexf, "graph")
        self.graph.set("mode", "static")
        if directed == True:
            self.graph.set("defaultedgetype", "directed")
        else:
    ...
    def insert_node_ecosystem(self, ecosystem):
        ...
        # Ecosystem node color set to red
    ...
    def insert_node_project_ecosystem(self, project, ecosystem):
        ...
        #Project node color set to green
        node_color = ET.SubElement(node, "viz:color")
        node_color.set("r", "0")
        ...
        #Linking project node to ecosystem node through an edge
    ...
    def insert_node_user(self, user, project):
        ...
        #Linking user node to project node through an edge
        edge = ET.SubElement(self.edges, "edge")
