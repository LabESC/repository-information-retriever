...
class user:
    ...
    def __init__(self, name, project_name, closeness, long_time, status, status_project, content_value, source_learning,
                 participation_code, participation_comments, user_commits, user_comments):
        self.ecosystem_influence_level = 0.0
        self.project_influence_level = 0.0
        self.user_name = name
        self.user_project = project_name

        #The Influencer characteristics
        ...
        #Perceval metrics
        self.user_commits_metric = user_commits
        self.user_comments_metric = user_comments
    ...
    def define_user_commits_metric(self, user_commits_metric):
        self.user_commits_metric = user_commits_metric

    def define_user_comments_metric(self, user_comments_metric):
        self.user_comments_metric = user_comments_metric
